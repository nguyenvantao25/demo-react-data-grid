...
const root = css`
  ...
  @layer rdg.Root {
    ...
    --rdg-cell-frozen-right-box-shadow: -4px 0 5px -2px rgba(136, 136, 136, 0.3);
    --rdg-border-width: 1px;
    --rdg-summary-border-width: calc(var(--rdg-border-width));
    --rdg-color: light-dark(#000, #ddd);
    /* --rdg-border-color: light-dark(#ddd, #444); */
    --rdg-border-color: light-dark(#ddd, #e0e0e0);
    --rdg-summary-border-color: light-dark(#aaa, #e0e0e0);
